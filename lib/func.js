...
export default class {
     ...
     * @param {function/null} @argument - Default: null. 'dumpFunc'.
     * 
     * @returns {object} this
     */
    static init = (...opt) => {
     ...
     * @param {function/null} @argument - Default: this.dumpFunc. 'dumpFunc'.
     * 
     * @returns {object} this
     */
    dump = (...opt) => {
    ...
    /**
     * @param {object} @argument - Default: {}. 'defaultMatch', 'defaultOptionsMatch', 'defaultPrimary', 'defaultPure', 'typesMatch', 'valuesMatch'
        ...
        return new Promise(async (resolve) => {
            ...
            for (let optValue of opt) {
                if (Object.prototype.toString.call(optValue) === `[object Object]`) {
                    if (Object.prototype.toString.call(optValue.defaultMatch) === `[object Boolean]`) {
                        defaultMatch = optValue.defaultMatch
                    }
                    if (Object.prototype.toString.call(optValue.defaultOptionsMatch) === `[object Boolean]`) {
                        defaultOptionsMatch = optValue.defaultOptionsMatch
                    }
                    if (Object.prototype.toString.call(optValue.defaultPrimary) === `[object Boolean]`) {
                        defaultPrimary = optValue.defaultPrimary
                    }
                    if (Object.prototype.toString.call(optValue.defaultPure) === `[object Boolean]`) {
                        defaultPure = optValue.defaultPure
                    }
                    if (Object.prototype.toString.call(optValue.typesMatch) === `[object Boolean]`) {
                        typesMatch = optValue.typesMatch
                    }
                    if (Object.prototype.toString.call(optValue.valuesMatch) === `[object Boolean]`) {
                        valuesMatch = optValue.valuesMatch
                    }
                } else if (Object.prototype.toString.call(optValue) === `[object Number]`) {
                    dumpLevel = optValue
            ...
            run = await corelight.validate(this, {options: this.opt, default: this.default, types: this.types, values: this.values, defaultMatch, defaultOptionsMatch, defaultPrimary, defaultPure, typesMatch, valuesMatch }, { dumpLevel, dumpFunc })
            if (run.error) {
